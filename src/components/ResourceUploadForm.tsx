...
const ResourceUploadForm: React.FC<ResourceUploadFormProps> = ({
  ...
  const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    if (e.target.files) {
      ...
      if (invalidFiles.length > 0) {
        setUploadError(
          `Some files are not valid. Please check file types and sizes (max ${maxFileSize}MB).`,
        )
        return
      }
  ...
  return (
    <div className="bg-white dark:bg-blue-950 jungle:bg-green-900 extra-dark:bg-gray-900 darksacramento:bg-green-950 rounded-lg shadow-md p-6">
      ...
      {uploadSuccess && (
        <div className="mb-4 bg-green-50 dark:bg-green-900/30 jungle:bg-green-900/30 extra-dark:bg-green-900/30 darksacramento:bg-green-900/30 border-l-4 border-green-500 p-4">
      ...
      {uploadError && (
        <div className="mb-4 bg-red-50 dark:bg-red-900/30 jungle:bg-red-900/30 extra-dark:bg-red-900/30 darksacramento:bg-red-900/30 border-l-4 border-red-500 p-4">
          <div className="flex items-center">
      ...
      <form onSubmit={handleSubmit}>
        <div className="mb-6">
          <label
            htmlFor="file-upload"
            className="block text-sm font-medium text-gray-700 dark:text-blue-300 jungle:text-green-300 extra-dark:text-gray-300 darksacramento:text-green-300 mb-2"
          >
            Upload Files
          </label>
          ...
          {tags.length > 0 && (
            <div className="mt-2 flex flex-wrap gap-2">
              {tags.map((tag) => (
                <span
                  key={tag}
                  className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-indigo-100 dark:bg-blue-900 jungle:bg-green-800 extra-dark:bg-gray-800 darksacramento:bg-green-800 text-indigo-800 dark:text-blue-300 jungle:text-green-300 extra-dark:text-gray-300 darksacramento:text-green-300"
                >
                  {tag}
                  <button
                    type="button"
                    onClick={() => handleRemoveTag(tag)}
                    className="ml-1.5 text-indigo-500 dark:text-blue-400 jungle:text-green-400 extra-dark:text-gray-400 darksacramento:text-green-400 hover:text-indigo-700 dark:hover:text-blue-300 jungle:hover:text-green-300 extra-dark:hover:text-gray-300 darksacramento:hover:text-green-300"
                  >
                    &times;
                  </button>
                </span>
        ...
        {citationFormat !== 'none' && (
          <div className="mb-6 p-4 border border-gray-200 dark:border-blue-800 jungle:border-green-800 extra-dark:border-gray-700 darksacramento:border-green-800 rounded-md">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label
                  htmlFor="author"
                  className="block text-xs font-medium text-gray-700 dark:text-blue-300 jungle:text-green-300 extra-dark:text-gray-300 darksacramento:text-green-300 mb-1"
                >
                  Author(s)
                </label>
                <input
                  ...
                  id="author"
                  name="author"
                  value={citationInfo.author}
                  onChange={handleCitationInfoChange}
                  placeholder="Last name, First initial. (e.g., Smith, J.)"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleCitationInfoChange}
                  placeholder="Publication year (e.g., 2023)"
                  className="block w-full border border-gray-300 dark:border-blue-700 jungle:border-green-700 extra-dark:border-gray-700 darksacramento:border-green-700 rounded-md shadow-sm py-1.5 px-3 focus:outline-none focus:ring-indigo-500 dark:focus:ring-blue-500 jungle:focus:ring-green-500 extra-dark:focus:ring-gray-500 darksacramento:focus:ring-green-500 focus:border-indigo-500 dark:focus:border-blue-500 jungle:focus:border-green-500 extra-dark:focus:border-gray-500 darksacramento:focus:border-green-500 sm:text-sm bg-white dark:bg-blue-900 jungle:bg-green-800 extra-dark:bg-gray-800 darksacramento:bg-green-900 text-gray-900 dark:text-blue-100 jungle:text-green-100 extra-dark:text-gray-100 darksacramento:text-green-100"
                />
              </div>
              <div className="md:col-span-2">
                ...
                <input
                  ...
                  id="citation-title"
                  name="title"
                  value={citationInfo.title}
                  onChange={handleCitationInfoChange}
                  placeholder="Title of the article, book, or resource"
                  className="block w-full border border-gray-300 dark:border-blue-700 jungle:border-green-700 extra-dark:border-gray-700 darksacramento:border-green-700 rounded-md shadow-sm py-1.5 px-3 focus:outline-none focus:ring-indigo-500 dark:focus:ring-blue-500 jungle:focus:ring-green-500 extra-dark:focus:ring-gray-500 darksacramento:focus:ring-green-500 focus:border-indigo-500 dark:focus:border-blue-500 jungle:focus:border-green-500 extra-dark:focus:border-gray-500 darksacramento:focus:border-green-500 sm:text-sm bg-white dark:bg-blue-900 jungle:bg-green-800 extra-dark:bg-gray-800 darksacramento:bg-green-900 text-gray-900 dark:text-blue-100 jungle:text-green-100 extra-dark:text-gray-100 darksacramento:text-green-100"
                />
              </div>
              <div>
                ...
                <input
                  ...
                  id="journal"
                  name="journal"
                  value={citationInfo.journal}
                  onChange={handleCitationInfoChange}
                  placeholder="Journal or periodical name (if applicable)"
                  className="block w-full border border-gray-300 dark:border-blue-700 jungle:border-green-700 extra-dark:border-gray-700 darksacramento:border-green-700 rounded-md shadow-sm py-1.5 px-3 focus:outline-none focus:ring-indigo-500 dark:focus:ring-blue-500 jungle:focus:ring-green-500 extra-dark:focus:ring-gray-500 darksacramento:focus:ring-green-500 focus:border-indigo-500 dark:focus:border-blue-500 jungle:focus:border-green-500 extra-dark:focus:border-gray-500 darksacramento:focus:border-green-500 sm:text-sm bg-white dark:bg-blue-900 jungle:bg-green-800 extra-dark:bg-gray-800 darksacramento:bg-green-900 text-gray-900 dark:text-blue-100 jungle:text-green-100 extra-dark:text-gray-100 darksacramento:text-green-100"
                />
              </div>
              <div>
                ...
                <input
                  ...
                  onChange={handleCitationInfoChange}
                  placeholder="Publisher name (for books, reports, etc.)"
                  className="block w-full border border-gray-300 dark:border-blue-700 jungle:border-green-700 extra-dark:border-gray-700 darksacramento:border-green-700 rounded-md shadow-sm py-1.5 px-3 focus:outline-none focus:ring-indigo-500 dark:focus:ring-blue-500 jungle:focus:ring-green-500 extra-dark:focus:ring-gray-500 darksacramento:focus:ring-green-500 focus:border-indigo-500 dark:focus:border-blue-500 jungle:focus:border-green-500 extra-dark:focus:border-gray-500 darksacramento:focus:border-green-500 sm:text-sm bg-white dark:bg-blue-900 jungle:bg-green-800 extra-dark:bg-gray-800 darksacramento:bg-green-900 text-gray-900 dark:text-blue-100 jungle:text-green-100 extra-dark:text-gray-100 darksacramento:text-green-100"
                />
              </div>
            ...
            {citationFormat === 'apa' &&
              ...
              citationInfo.year &&
              citationInfo.title && (
                <div className="mt-4 p-3 bg-gray-50 dark:bg-blue-900/30 jungle:bg-green-900/30 extra-dark:bg-gray-900/30 darksacramento:bg-green-900/30 rounded-md">
